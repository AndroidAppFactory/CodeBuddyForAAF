...
│   ├── aaf_doc_management.mdc      # 文档管理规则
│   ├── aaf_git.mdc                 # Git 提交规范
│   ├── aaf_note.mdc                # 注释规范
│   └── aaf_release_check.mdc       # 发布检查规则
├── init.sh                          # 项目初始化脚本
├── README.md                        # 项目说明文档
...
| `aaf_demo.mdc` | Demo 开发规范（Template-Empty） |
| `aaf_dependency.mdc` | 集中式依赖管理规范 |
| `aaf_doc_inspection.mdc` | 文档完整性巡检规则 |
| `aaf_doc_management.mdc` | 文档生成、同步、更新统一管理 |
| `aaf_git.mdc` | Git Commit Message 规范 |
| `aaf_note.mdc` | 代码注释规范和文档编写标准 |
| `aaf_release_check.mdc` | 发布前自动检查（编译、版本号、模块） |
