...
def _add_win_args(sub_parser, sub_command: str) -> None:
    """给 win 平台子命令追加专有参数"""
    # win 当前无额外平台专有参数
    pass
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = build_parser(
        "win",
        description="ZixieKit Windows Replay - 录制/回放/编排",
        add_platform_args=_add_win_args,
    )
